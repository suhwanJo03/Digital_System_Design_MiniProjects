...
HD_PWD='D:/DSD2025/advanced_practice_1/prob2_CONV_1D/CONV_1D.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log conv1d.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source conv1d.tcl
