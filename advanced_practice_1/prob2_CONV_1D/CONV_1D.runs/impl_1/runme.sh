...
HD_PWD='D:/DSD2025/advanced_practice_1/prob2_CONV_1D/CONV_1D.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log conv1d.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source conv1d.tcl -notrace
