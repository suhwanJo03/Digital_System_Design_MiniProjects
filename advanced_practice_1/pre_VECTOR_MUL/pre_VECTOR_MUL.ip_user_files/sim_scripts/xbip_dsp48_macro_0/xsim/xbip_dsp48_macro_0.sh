...
#
# Script generated by Vivado on Thu Sep 04 21:06:45 +0900 2025
...
#
# Usage        : xbip_dsp48_macro_0.sh
#                xbip_dsp48_macro_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                xbip_dsp48_macro_0.sh [-reset_run]
#                xbip_dsp48_macro_0.sh [-reset_log]
#                xbip_dsp48_macro_0.sh [-help]
#
...
# script info
echo -e "xbip_dsp48_macro_0.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./xbip_dsp48_macro_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_dsp48_wrapper_v3_0_4 -L xbip_utils_v3_0_10 -L xbip_pipe_v3_0_6 -L dsp_macro_v1_0_3 -L xil_defaultlib -L secureip -L xpm --snapshot xbip_dsp48_macro_0 xil_defaultlib.xbip_dsp48_macro_0 -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb xbip_dsp48_macro_0.wdb xsim.dir libdpi.so)
...
Usage: xbip_dsp48_macro_0.sh [-step]\n\
Usage: xbip_dsp48_macro_0.sh [-lib_map_path]\n\
Usage: xbip_dsp48_macro_0.sh [-reset_run]\n\
Usage: xbip_dsp48_macro_0.sh [-reset_log]\n\
Usage: xbip_dsp48_macro_0.sh [-keep_index]\n\
