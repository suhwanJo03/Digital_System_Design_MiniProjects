...
#set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33     } [get_ports { oled_cs }]; #CS
#set_property -dict { PACKAGE_PIN W8    IOSTANDARD LVCMOS33     } [get_ports { oled_spi_data }]; #MOSI        
##set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33     } [get_ports { gpio_rtl_tri_o[2] }]; #MISO       
#set_property -dict { PACKAGE_PIN V7    IOSTANDARD LVCMOS33     } [get_ports { oled_spi_clk }]; #SCLK      
#set_property -dict { PACKAGE_PIN Y7    IOSTANDARD LVCMOS33     } [get_ports { oled_dc_n }]; #D/C     
#set_property -dict { PACKAGE_PIN Y6    IOSTANDARD LVCMOS33     } [get_ports { oled_reset_n }]; #Reset      
#set_property -dict { PACKAGE_PIN V6    IOSTANDARD LVCMOS33     } [get_ports { oled_vbat }]; #VBATC          
#set_property -dict { PACKAGE_PIN W6    IOSTANDARD LVCMOS33     } [get_ports { oled_vdd }]; #VDDC            
